...
- text: A small, dark-colored cat is captured mid-stride, walking down the center
    ...
    halftone texture
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/00.jpg
- text: 'This is a digital illustration with a retro, pixelated aesthetic, depicting
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/03.jpg
- text: A young woman with fair skin and blonde hair styled in curls sits on the floor
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/05.jpg
- text: A black and white photograph captures a male rockstar performing on stage,
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/06.jpg
- text: A black and white photograph captures a solitary man standing on a wooden
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/07.jpg
- text: An anime illustration depicts a young boy and girl walking through a lush
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/13.jpg
- text: vintage analog collage, central irregularly shaped snowy mountain range with
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/18.jpg
- text: A minimalist flat-color illustration of a person wading through expansive
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/20.jpg
- text: A tiny figure and a small white dog sit side-by-side in the deep green shadow
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/21.jpg
- text: A close-up portrait of a young East Asian woman with straight black hair,
    ...
    of field.
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/22.jpg
- text: A tiny, russet-brown harvest mouse clings to a slender diagonal branch amid
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/23.jpg
- text: A dynamic digital painting of a joyful girl in a sailor uniform stretching
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/24.jpg
- text: stylized digital painting of a dark convertible on a winding coastal cliff
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/25.jpg
- text: A stylized jungle illustration densely packed with oversized flora and surreal
    ...
    textured depth.
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/27.jpg
- text: A surreal retro-futuristic space scene features liquid chrome forming an abstract
    ...
    metallic rendering.
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/28.jpg
- text: An extreme close-up portrait featuring pale, freckled skin and a single blue
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/29.jpg
- text: Stylized digital painting of a menacing jester figure rendered with bold,
    ...
    art.
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/30.jpg
- text: A surreal black-and-white ink illustration of three interlocking, heavily
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/32.jpg
- text: 1990s vintage anime style cel animation, densely packed crowd of teenagers
    ...
    retro.
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/33.jpg
- text: extreme close-up of a woman's face partially obscured by tousled dark brown
  ...
  output:
    url: https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/35.jpg
---

# Krea 2 Text-to-Image Model

This repository provides **GGUF quantized version** of the **Krea 2 OSS Turbo**.  

**Watch us on Youtube:** [@VantageWithAI](https://www.youtube.com/@vantagewithai) 

See our collection of in-house trained LoRAs trained on Raw and meant to be used with Turbo: [Krea-2 LoRA Collection](https://huggingface.co/collections/krea/krea-2-loras)

![Krea 2 sample outputs](https://huggingface.co/krea/Krea-2-Turbo/resolve/main/images/header.jpg)
