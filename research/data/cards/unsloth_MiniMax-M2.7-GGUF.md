...
<div>
  <p style="margin-bottom: 0; margin-top: 0;">
    <h1 style="margin-top: 0rem;">See how to run MiniMax-M2.7 locally - <a href="https://unsloth.ai/docs/models/minimax-m27">Read our Guide!</a></h1>
  </p>
<p style="margin-top: 0;margin-bottom: 0;">
  ...
  <div style="margin-top: 0;display: flex; gap: 5px; align-items: center; ">
    ...
    <a href="https://unsloth.ai/docs/models/minimax-m27">
      <img src="https://raw.githubusercontent.com/unslothai/unsloth/refs/heads/main/images/documentation%20green%20button.png" width="143">
    </a>
  </div>
</div>

You can follow instructions in our [guide here](https://unsloth.ai/docs/models/minimax-m27).<br>
...
![minimaxm2.7 benchmarks](https://cdn-uploads.huggingface.co/production/uploads/62ecdc18b72a69615d6bd857/EMKkh5SwftODMFZ3vLwkm.jpeg)
