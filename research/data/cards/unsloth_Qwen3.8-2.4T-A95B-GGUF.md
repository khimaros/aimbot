...
- unsloth
---
# Read our How to [Run Qwen3.8 Guide!](https://unsloth.ai/docs/models/qwen3.8)
<p style="margin-top: 0;margin-bottom: 0;">
  ...
  <div style="display: flex; gap: 5px; align-items: center; ">
    ...
    <ul style="margin: 0;">
    <li>See our <a href="https://unsloth.ai/docs/models/qwen3.8">Qwen3.8 guide</a> for quantization analysis and instructions.</li>
    <li>You can now run Qwen3.8 in <a href="https://github.com/unslothai/unsloth/">Unsloth Desktop</a> with toggles for thinking.</li>
    <li>New sub IQ1_S data-types Q1_0 <a href="https://unsloth.ai/docs/models/qwen3.8#new-sub-1-bit-data-types">(IQ1_XXXXS)</a> for Qwen 3.8</li>
