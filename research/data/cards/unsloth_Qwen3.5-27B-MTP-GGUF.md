...
- qwen3_5
---
# Read our How to [Run Qwen3.5 MTP Guide!](https://unsloth.ai/docs/models/qwen3.5#mtp-guide)
<div>
...
```bash
export LLAMA_CACHE="unsloth/Qwen3.5-27B-MTP-GGUF"
./llama.cpp/llama-server \
    -hf unsloth/Qwen3.5-27B-MTP-GGUF:UD-Q4_K_XL \
...
Set `-DGGML_CUDA=OFF` for CPU/Metal. `-np > 1` and `--mmproj` are not yet supported with MTP.
    ...
    <li>Developer Role Support so Qwen3.5 can work in Codex, OpenCode and more!</li>
