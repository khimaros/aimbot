...
Disable thinking via `--chat-template-kwargs '{"enable_thinking":false}'`. [Read our guide](https://unsloth.ai/docs/models/qwen3.5#how-to-enable-or-disable-reasoning-and-thinking).
...
- See our new benchmarks for [122B-A10B here](https://unsloth.ai/docs/models/qwen3.5/gguf-benchmarks).
![horiztonal plot](https://cdn-uploads.huggingface.co/production/uploads/62ecdc18b72a69615d6bd857/04yZt_GB2O-7l96kDhaNI.png)

For Qwen3.5-35B-A3B, we primarily reduced the maximum KLD:

![image](https://cdn-uploads.huggingface.co/production/uploads/62ecdc18b72a69615d6bd857/SZ0aJWxFHI8PYvc8vjyGg.png)
...
- We also benchmarked GGUFs & removed MXFP4 layers from 3 quants. [Read analysis here.](https://unsloth.ai/docs/models/qwen3.5/gguf-benchmarks)

Please follow the correct instructions / settings in our [guide here](https://unsloth.ai/docs/models/qwen3.5).

## Fine-tuning and RL Qwen3.5
- You can also fine-tune and perform [reinforcement learning (RL)](https://unsloth.ai/docs/get-started/reinforcement-learning-rl-guide) on all Qwen3.5 models with Unsloth via our [free Colab notebooks](https://unsloth.ai/docs/get-started/unsloth-notebooks#standard-sft-notebooks).
- Read our [Qwen3.5 fine-tuning guide](https://unsloth.ai/docs/models/qwen3.5/fine-tune) for tips, VRAM requirements, code and more [here](https://unsloth.ai/docs/models/qwen3.5/fine-tune).
