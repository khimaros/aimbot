...
GGUF / ggml conversions of [`nvidia/parakeet-tdt-0.6b-v3`](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v3) for use with the `parakeet-main` CLI from **[CrispStrobe/CrispASR](https://github.com/CrispStrobe/CrispASR/)**.
...
- **Upstream model:** [nvidia/parakeet-tdt-0.6b-v3](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v3) — published by `nvidia`.
