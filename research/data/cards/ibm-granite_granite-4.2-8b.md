...
* **Feed-Forward:** MLP with SwiGLU activation (hidden size 12800)
...
<tbody>
  <tr>
    ...
    <td style="text-align:center; background-color: #DAE8FF;">4096</td>
  ...
  <tr>
    ...
    <td style="text-align:center;">64</td>
    <td style="text-align:center; background-color: #DAE8FF;">128</td>
    <td style="text-align:center;">128</td>
  </tr>
  <tr>
    <td style="text-align:left;">Number of attention heads</td>
    <td style="text-align:center;">40</td>
    <td style="text-align:center; background-color: #DAE8FF;">32</td>
  ...
  <tr>
    ...
    <td style="text-align:center; background-color: #DAE8FF;">12800</td>
  ...
  <tr>
    ...
    <td style="text-align:center; background-color: #DAE8FF;">8B</td>
...
Granite-4.2-8B is post-trained from [Granite-4.1-8B-Base](https://huggingface.co/ibm-granite/granite-4.1-8b-base) through a rigorous multi-stage pipeline that progressively unlocks reasoning, tool use, and instruction-following capabilities. A full listing of training datasets is available in the [Granite 4.2 GitHub repository](https://github.com/ibm-granite/granite-4.2-language-models). The training pipeline consists of three stages:

### Stage 1: Pre-Training

<!-- TODO: Add pre-training details here -->

Granite-4.2-8B builds on [Granite-4.1-8B-Base](https://huggingface.co/ibm-granite/granite-4.1-8b-base), which was pre-trained on a large-scale English as well as multilingual corpus. For full pre-training details (data composition, training recipe, and infrastructure), refer to our [Granite 4.1 Technical Blog](https://huggingface.co/blog/ibm-granite/granite-4-1).
...
<tr>
    ...
    <td style="text-align:center; background-color: #DAE8FF;">30.78</td><td style="text-align:center;">41.89</td>
</tr>
<tr>
    <td>SWE Bench Pro</td>
    <td style="text-align:center;">NA</td>
    <td style="text-align:center; background-color: #DAE8FF;">19.11</td><td style="text-align:center;">33.29</td>
</tr>
<tr>
    <td>SWE Bench Verified</td>
    <td style="text-align:center;">NA</td>
    <td style="text-align:center; background-color: #DAE8FF;">47.67</td><td style="text-align:center;">57</td>
</tr>
<tr>
    <td>Terminal-Bench 2.1</td>
    <td style="text-align:center;">NA</td>
    <td style="text-align:center; background-color: #DAE8FF;">20.56</td><td style="text-align:center;">29.24</td>
</tr>
<tr>
...
<!-- <tr>
    ...
    <td style="text-align:center; background-color: #DAE8FF;">66.34</td><td style="text-align:center;">68.05</td>
</tr> -->
<tr>
    <td>τ³-bench (AVG)</td>
    <td style="text-align:center;">45.78</td>
    <td style="text-align:center;background-color: #DAE8FF;">58.06</td><td style="text-align:center;">62.00</td>
</tr>
<tr>
    <td>BFCL (v4)</td>
    <td style="text-align:center;">52.41</td>
    <td style="text-align:center; background-color: #DAE8FF;">52.39</td><td style="text-align:center;">61.39</td>
</tr>
<tr>
    <td>ProfBench</td>
    <td style="text-align:center;">32.10</td>
    <td style="text-align:center; background-color: #DAE8FF;">41.20</td><td style="text-align:center;">42.90</td>
</tr>
<tr>
    <td>BirdBench</td>
    <td style="text-align:center;">NA</td>
    <td style="text-align:center; background-color: #DAE8FF;">41.07</td><td style="text-align:center;">41.85</td>
</tr>
<tr>
    <td>GDPval</td>
    <td style="text-align:center;">NA</td>
    <td style="text-align:center; background-color: #DAE8FF;">1189</td><td style="text-align:center;">1225</td>
</tr>
<tr>
...
<tr>
    ...
    <td style="text-align:center; background-color: #DAE8FF;">86.67</td><td style="text-align:center;">89.17</td>
</tr>
<tr>
    <td>HMMT Feb25</td>
    <td style="text-align:center;">66.67</td>
    <td style="text-align:center; background-color: #DAE8FF;">78.33</td><td style="text-align:center;">89.17</td>
</tr>
<tr>
    <td>GPQA</td>
    <td style="text-align:center;">54.80</td>
    <td style="text-align:center; background-color: #DAE8FF;">64.14</td><td style="text-align:center;">66.41</td>
</tr>
<tr>
    <td>LiveCodeBench v6</td>
    <td style="text-align:center;">69.71</td>
    <td style="text-align:center; background-color: #DAE8FF;">73.24</td><td style="text-align:center;">75.77</td>
</tr>
<tr>
    <td>SciCode</td>
    <td style="text-align:center;">24.11</td>
    <td style="text-align:center; background-color: #DAE8FF;">36.09</td><td style="text-align:center;">38.76</td>
</tr>
<tr>
...
<tr>
    ...
    <td style="text-align:center; background-color: #DAE8FF;">74.04</td><td style="text-align:center;">77.60</td>
</tr>
<tr>
    <td>MMLU-ProX lite (IBM)</td>
    <td style="text-align:center;">27.78</td>
    <td style="text-align:center; background-color: #DAE8FF;">61.06</td><td style="text-align:center;">66.64</td>
</tr>
<tr>
    <td>Arena-Hard-V2</td>
    <td style="text-align:center;">34.96</td>
    <td style="text-align:center; background-color: #DAE8FF;">65.19</td><td style="text-align:center;">67.93</td>
</tr>
<tr>
    <td>IFBench (prompt)</td>
    <td style="text-align:center;">74.33</td>
    <td style="text-align:center; background-color: #DAE8FF;">79.33</td><td style="text-align:center;">77.17</td>
</tr>
<tr>
...
<tr>
    ...
    <td style="text-align:center; background-color: #DAE8FF;">80.99</td><td style="text-align:center;">89.96</td>
</tr>
<tr>
    <td>RULER 128K</td>
    <td style="text-align:center;">55.30</td>
    <td style="text-align:center; background-color: #DAE8FF;">71.41</td><td style="text-align:center;">81.38</td>
</tr>
</tbody></table>
...
Granite-4.2-8B is optimized for deployment with [vLLM](https://github.com/vllm-project/vllm).
...
Granite-4.2-8B can also be served with [SGLang](https://github.com/sgl-project/sglang) (v0.5.18+) for high-throughput inference.
...
Granite-4.2-8B can be used as the backbone model for agentic coding tools. Since it supports reasoning and tool calling via the OpenAI-compatible API, it integrates with popular agentic harnesses out of the box. Start the vLLM server as shown in the [Serving with vLLM](#serving-with-vllm) section above, then follow the harness-specific instructions below.
...
**Configure** `~/.config/opencode/opencode.json` (with reasoning enabled):
...
The key fields for reasoning:
- **`"body.chat_template_kwargs"`** — passes `enable_thinking` to vLLM via the request body, which the Granite chat template uses to activate `<think>...</think>` reasoning.
- **`"compatibility.reasoningField": "reasoning"`** — tells OpenCode which response field contains the model's chain-of-thought (vLLM returns it in the `reasoning` field).

To disable reasoning, set `"enable_thinking": false` in the `chat_template_kwargs` block.
...
**Configure** `~/.pi/agent/models.json` (with reasoning and effort-level control):
...
The key fields for reasoning:
- **`"thinkingFormat": "chat-template"`** — routes Pi's thinking controls through vLLM's `chat_template_kwargs`, which is how Granite handles reasoning modes.
- **`"chatTemplateKwargs"`** — maps Pi's thinking toggle to `enable_thinking` and effort control to `low_effort`.
- **`"reasoning": true`** — tells Pi to expect and display chain-of-thought reasoning output.
- **`"thinkingLevelMap"`** — maps Pi's effort levels to Granite's two reasoning modes: "low" enables low-effort reasoning (`low_effort=true`, shorter chains), "high" uses full reasoning (default).
...
Then select the `granite-4.2-8b` model with `/model` or `Ctrl+L` in the interactive session.

**Verifying reasoning output:**

The configuration above sets `"reasoning": true`, which tells Pi to expect and display chain-of-thought reasoning from the model. You can verify reasoning is working correctly via the API:
...
# Reasoning content contains the model's chain-of-thought
...
To disable reasoning (for faster responses on simple queries), set `enable_thinking` to `False`:
...
# No reasoning content — direct answer only
...
model_path = "ibm-granite/granite-4.2-8b"
...
Granite-4.2-8B supports tool calling with integrated reasoning — the model thinks about which tool to call and why before making the call. Tools are defined using the [OpenAI function definition schema](https://platform.openai.com/docs/guides/function-calling).
