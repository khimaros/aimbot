...
## KLD Benchmarks:
* Note MXFP4-MOE is known to have worse KLD vs disk space - use UD-Q4_K_XL instead.
* mmproj / vision works as well
![image](https://cdn-uploads.huggingface.co/production/uploads/62ecdc18b72a69615d6bd857/dtv9_p1Eoj_GGptLEBmGr.png)
